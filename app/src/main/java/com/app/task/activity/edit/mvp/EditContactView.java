...
public class EditContactView extends FrameLayout {
    ...
    boolean isfirstValid, isLastValid, isemailValid, isAddresvalid, isdescriptionValid, isImageSelected = true;
    String imagePath;
    private SuccessDialogView successDialogView;

    public EditContactView(AppCompatActivity activity,SuccessDialogView successDialogView) {
        super(activity);
    ...
    public void setInfo(ContactInfoModel info){
        ...
        etAddressName.setText(info.getAddress());
        etEmailAddress.setText(info.getEmail());
      ...
      if(info.getGender()=="Male"){
        ...
        etDescription.setText(info.getDescription());
    ...
    public void showSuccessDailog(){
        ...
        successDialogView.setSuccessmsg("Task has been updated successfully");
    }
